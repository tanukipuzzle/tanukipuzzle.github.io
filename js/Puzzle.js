...
var puzzleGrid = [0, 1, 2, 
				  0, 0, 0, 
				  3, 0, 0];

var movingGrid = [1, 0, 0, 
				  0, 2, 0, 
				  0, 0, 3];
...
const PUZZLE_CROSS_SLOT_2 = 4;
const PUZZLE_TRIANGLE_SLOT_2 = 5;
const PUZZLE_CIRCLE_SLOT_2 = 6;
const PUZZLE_CROSS_SLOT_3 = 8;
const PUZZLE_TRIANGLE_SLOT_3 = 9;
const PUZZLE_CIRCLE_SLOT_3 = 10;

const MOVING_EMPTY = 0;
const MOVING_CROSS = 1;
const MOVING_TRIANGLE = 2;
const MOVING_CIRCLE = 3;
const MOVING_CROSS_2 = 4;
const MOVING_TRIANGLE_2 = 5;
const MOVING_CIRCLE_2 = 6;
const MOVING_CROSS_3 = 8;
const MOVING_TRIANGLE_3 = 9;
const MOVING_CIRCLE_3 = 10;
...
function winCheck(){
	...
	if (notMatch == 0) {
		puzzlesCompleted++;
		if (puzzlesCompleted < 3) { //number of puzzles for Ishy to complete here
		colorText("Puzzle Complete! Puzzles Completed: "+puzzlesCompleted+"/3", 220,525, "white");
		colorText("Click anywhere for the next puzzle.", 240,555, "white");
		gameWon = 1;
		}
	}
}
